...
COPY diabetes FROM 'C:/Users/migue/Documents/PROYECTOS DATA SCIENCE/practicas_data_eng_local/data/datalake/diabetes_dataset/diabetes_dataset_clean.csv' DELIMITER ',' CSV HEADER;

CREATE TABLE diabetes_dictionary (
